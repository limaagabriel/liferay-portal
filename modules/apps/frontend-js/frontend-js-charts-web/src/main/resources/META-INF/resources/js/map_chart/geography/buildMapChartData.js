...
function buildMapChartData(topology) {
	...
	for (const geometry of topology.objects.countries.geometries) {
		...
		mapChartData[key] = buildCountryData(geometry, decodedArcs);
	}
...
function formatMapChartDataModule(mapChartData) {
	const header = [
		'/**',
		` * SPDX-FileCopyrightText: (c) ${new Date().getFullYear()} Liferay, Inc. https://liferay.com`,
		' * SPDX-License-Identifier: LGPL-2.1-or-later OR LicenseRef-Liferay-DXP-EULA-2.0.0-2023-06',
		' */',
		'',
		'/**',
		' * Generated by `buildMapChartData.js`. Do not hand-edit.',
		' *',
		' * @generated',
		' */',
		'',
	...
	const body = `export const WORLD_MAP_DATA: Record<string, {centroid: [number, number]; d: string}> = ${JSON.stringify(
		mapChartData,
		null,
		'\t'
	)};\n`;
...
function main() {
	...
	const mapChartData = buildMapChartData(topology);
