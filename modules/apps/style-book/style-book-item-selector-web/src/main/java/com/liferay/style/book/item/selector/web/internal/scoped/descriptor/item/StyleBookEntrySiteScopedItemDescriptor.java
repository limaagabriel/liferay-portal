...
import com.liferay.style.book.item.selector.web.internal.scoped.frontend.taglib.clay.servlet.taglib.StyleBookEntrySiteScopedVerticalCard;
 ...
 * @author Gabriel Lima
 */
public class StyleBookEntrySiteScopedItemDescriptor
	...
	public String getPayload() {
		return JSONUtil.put(
			...
			"styleBookEntryScopeERC", StringPool.BLANK
		).toString();
	}
